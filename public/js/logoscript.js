(function() {
    ...
    3: [function(j, q, z) {
        ...
        q.exports = function(t) {
            ...
            function o() {
                var t, e = y.getBoundingClientRect(), n = e.width, r = e.height;
                for (b.length = 0,
                t = 0; t < S.length; ++t) {
                    var o = S[t]
                      , a = o.indices
            ...
            var h = t || {}
              ...
              , b = [];
            h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0,
            A = 0 | (window.innerHeight * h.height || p),
            "minWidth"in h && p < h.minWidth && (p = h.minWidth,
            A = p)),
            ...
            var S = function() {
              ...
              , k = function() {
                ...
                return function() {
                    ...
                    w) {
                        var m = Date.now() / 1e3;
                        rotate(r, r, .1 + .2 * Math.sin(m / 3), s),
                        rotate(r, r, .03 * Math.sin(m / 2) - .1, h),
                        rotate(r, r, .5 + .2 * Math.sin(m / 3), f)
                    }
                    return multiply(u, n, i),
                    multiply(u, u, r),
                    u
                }
            }();
            return document.getElementById("pass").addEventListener('keyup', function(t){
                const inputLength = t.target.value.length;
                const caret = t.target.selectionStart;
                const rect = t.target.getBoundingClientRect();
                console.log("rect===>", rect.x, rect.y, caret, rect.left + 10 * inputLength);
                v || l(),
                c && (e({
                    x: rect.x + 5 * caret,
                    y: rect.y
            ...
            }),document.getElementById("modal-container").addEventListener("mousemove", function(t) {
                v || l(),
                c && (e({
                    x: t.clientX,
                    y: t.clientY
    ...
    7: [function(g, j, w) {
        function lookAt(t, a, e, r) {
            ...
            return Math.abs(l - f) < 1e-6 && Math.abs(y - m) < 1e-6 && Math.abs(k - p) < 1e-6 ? x(t) : (d = l - f,
            q = y - m,
            u = k - p,
    ...
    10: [function(F, G, H) {
        function rotate(t, a, r, e) {
            ...
            return Math.abs(E) < 1e-6 ? null : (E = 1 / E,
            B *= E,
            C *= E,
            D *= E,
            o = Math.sin(r),
    ...
    12: [function(b, c, d) {
        c.exports = function() {
            ...
            console.log("n.tagName.toLocaleUpperCase():",n.tagName.toLocaleUpperCase());
            ...
            function() {
                ...
                e.rangeCount || t.forEach(function(n) {
                    e.addRange(n)
                }),
                n && n.focus()
            }
